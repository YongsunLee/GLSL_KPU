...
void Renderer::DrawTexture()
{
	...
	glBindTexture(GL_TEXTURE_2D, m_TexTwice);
...
void Renderer::TextureVBO()
{
	float TextureWLongRect[]
		=
	{
		-0.1f, -1.f, 0.f, 0.0f, 0.0f,
		-0.1f,  1.f, 0.f, 0.0f, 1.0f,
		 0.1f,  1.f, 0.f, 1.0f, 1.0f,
		-0.1f, -1.f, 0.f, 0.0f, 0.0f,
		 0.1f,  1.f, 0.f, 1.0f, 1.0f,
		 0.1f, -1.f, 0.f, 1.0f, 0.0f
	};
